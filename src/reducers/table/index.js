const reduceAct = require('./reduceAct');
const reduceDeal = require('./reduceDeal');
const reducePostBlind = require('./reducePostBlind');
...
exports.reducePostBlind = reducePostBlind;
