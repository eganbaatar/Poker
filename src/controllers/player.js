...
Player.prototype.evaluateHand = function (board) {
  ...
  var swap = function (index1, index2) {
    if (
      cardNamess.indexOf(cards[index1][0]) <
      cardNamess.indexOf(cards[index2][0])
    ) {
  ...
  for (var i = 1; i < 7; i++) {
    ...
    var previousCardValue = cardNamess.indexOf(
      straight[straight.length - 1][0]
    );
      ...
      if (numberOfPairs == 1) {
        ...
        if (!evaluatedHand.cards.length) {
          ...
          if (
            ...
            if (
              cardNamess.indexOf(pairKeys[0]) > cardNamess.indexOf(pairKeys[2])
            ) {
            ...
            if (
              cardNamess.indexOf(pairKeys[1]) > cardNamess.indexOf(pairKeys[2])
            ) {
